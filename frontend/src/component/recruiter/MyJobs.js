...
// import "../recruiter/animations.css"
  ...
  return (
    ...
    <Grid container>
      <Grid container item xs={9} spacing={1} direction="column">
        ...
        <Grid item>Minimum Tenth percentage {job.min10thPercentage}</Grid>
        <Grid item>Minimum Twelfth percentage {job.min12thPercentage}</Grid>
        <Grid item>Minimum Graduation GPA {job.minGraduationGPA}</Grid>

        <Grid item>Qualification {job.qualification}</Grid>

        <Grid item>Age Limit {job.ageLimit}</Grid>
      ...
      <Grid item container direction="column" xs={3}>
        <Grid item xs>
          <Button
            variant="contained"
            className={`${classes.statusBlock} ${classes.viewApplicationsButton}`}
        ...
        <Grid item>
          <Button
            variant="contained"
            className={`${classes.statusBlock} ${classes.updateDetailsButton}`}
        ...
        <Grid item>
          <Button
            variant="contained"
            className={`${classes.statusBlock} ${classes.deleteButton}`}
        ...
        >
          <Grid item xs>
            ...
            <Button
              variant="contained"
              color="primary"
              style={{ padding: "10px 10px",position: "relative",left: "450px",top: "90px"}}
              
              onClick={() => window.location.href='/ScheduleInterview'}
            >
              Schedule Interview
            </Button>
